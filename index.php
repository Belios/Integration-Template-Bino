...
<section id="home"> <!-- Page d'accueil -->
  ...
  <div class="row align-items-start">
    <div class="d-flex justify-content-around">
      ...
      <div class="col-sm-3 mr-5 ">
        ...
        <div class="text-center">
          <h5>CLEA<span class="underline">N C</span>ODE</h5>
        </span>
            <br>
            </div>
              <div class="text-center">
      ...
      <div class="col-sm-3 mr-5">
        ...
        <div class="text-center">
          <h5>FREE <span class="underline">SUP</span>PORT</h5>
          </span>
            <br>
            <p id="serif"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore</p>
        </div>
      ...
      <div class="col-sm-6 half-left">
        ...
        <h3 id="h3-1"> OUR SERVICES </h3>
          ...
          <div class="row-a d-flex justify-content-end">
            <div class="border-1 border col-sm-9 mt-5 d-flex justify-content-end">
              <span class="color">
                <h5 class="tlepos">WEB DESIGN</h5>
              <p class="txtpos">Lorem Ipsum is simply dummy text of the printing and tyepesetting industry. Lorem Ip sum has been the industry's standard dummy text ever.</p></span>
          </div>
        </div>
